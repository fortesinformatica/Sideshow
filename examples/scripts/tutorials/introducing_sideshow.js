...
// 		},
	 ...
	 //    			$('#bttf figure').on('dragover', function (e) {
		...
		//     	}
		//     },
		//     targets: "#bttf figure #dr_brown, #dr_brown",
		//     subject: "#bttf",
...
![Fortes Informática Logo](examples/images/fortes-logo.png)
		...
		{
			title: "Events",
			text: "You can listen to events like `beforeStep`, `afterStep`, `beforeWizardStarts`, `afterWizardEnds` and do whatever you want. Like prepare the environment for the next step.",
			format: "markdown"
		}
    ]
});
